...
void teste_buscarVertice_deveEncontrarVerticeExistente(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 5.7, 8.0));
...
void teste_buscarVertice_deveRetornarNULLParaIDInexistente(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 7.7, 8.9));
...
void teste_inserirArestaGrafo_deveVerificarDirigibilidadeGrafo(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 16.7, 20.0));
    inserirVerticeGrafo(g,criarVertice("v2", 12.7, 10.0));

    inserirArestaGrafo(g, criarAresta("v1", "v2", "CEP103", "CEP301", 35.6, 65.0, "Rua Santa Angela"));
...
void teste_inserirArestaGrafo_deveInserirDuasArestasFormamRuaMaoDupla(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 14.7, 22.0));
    inserirVerticeGrafo(g,criarVertice("v2", 10.7, 16.0));

    inserirArestaGrafo(g, criarAresta("v1", "v2", "CEP203", "CEP321", 30.6, 70.0, "Rua Santa Maria"));
    inserirArestaGrafo(g, criarAresta("v2", "v1", "CEP412", "CEP405", 30.6, 50.0, "Rua Santa Maria"));
...
void teste_getNumArestasGrafo_deveContarNumeroArestasCorretamente(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 11.7, 26.0));
    inserirVerticeGrafo(g,criarVertice("v2", 18.7, 16.0));
    inserirVerticeGrafo(g,criarVertice("v3", 21.7, 26.0));
    inserirVerticeGrafo(g,criarVertice("v4", 26.7, 17.0));


    inserirArestaGrafo(g, criarAresta("v1", "v2", "CEP412", "CEP405", 40.6, 70.0, "Rua Santa Monica"));
    inserirArestaGrafo(g, criarAresta("v1", "v3", "CEP405", "CEP413", 50.6, 80.0, "Rua Esperanca"));
    inserirArestaGrafo(g, criarAresta("v2", "v4", "CEP414", "CEP405", 45.6, 50.0, "Rua Natal"));
    inserirArestaGrafo(g, criarAresta("v4", "v3", "CEP415", "CEP405", 39.6, 60.0, "Rua Coritiba"));
...
void teste_getVerticesGrafo_deveRetornarListaComTodosVerticesInseridos(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 31.7, 16.0));
    inserirVerticeGrafo(g,criarVertice("v2", 25.5, 14.7));
    inserirVerticeGrafo(g,criarVertice("v3", 43.5, 24.7));
...
void teste_liberarGrafo_naoDeveCrasharComVerticesEArestas(void) {
    Grafo g = criarGrafo();
    inserirVerticeGrafo(g,criarVertice("v1", 12.0, 14.0));
    inserirVerticeGrafo(g,criarVertice("v2", 21.5, 34.7));
    inserirArestaGrafo(g, criarAresta("v1", "v2", "CEP405", "CEP412", 40.6, 70.0, "Rua Santa Monica"));
    liberarGrafo(g);
    TEST_PASS();
}
